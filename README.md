...
Description: A map of managed private endpoints. The map key is the supplied input to var.managed\_private\_endpoints. The map value is the entire azurerm\_grafana\_managed\_private\_endpoint resource.
